...
func (c *Client) DAndroid1(url string) (interface{}, error) {
...
func (c *Client) DApkMirror(url string) (interface{}, error) {
...
func (c *Client) DApkPure(url string) (interface{}, error) {
...
func (c *Client) DPlayStore(url string) (interface{}, error) {
